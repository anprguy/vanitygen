    ...
    def run(self):
        ...
        while self.running:
            ...
            if self.mode == 'hybrid':
                ...
                keys_generated_total = total_keys  # Hybrid uses total_generated
                keys_checked_total = total_keys    # Same in hybrid mode
...
class VanityGenGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.stats_label = QLabel("Keys Generated: 0 | Keys Checked: 0 | Speed: 0 keys/s")
...
"""
    ...
    def update_stats(self, keys_generated, keys_checked, speed):
        # Show both counters - "Keys Generated" and "Keys Checked"
